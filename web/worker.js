// Generated by dart2js (NullSafetyMode.sound, csp, intern-composite-values), the Dart to JavaScript compiler version: 3.2.0-134.1.beta.
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t1.then$1$1(new A.main__closure(), type$.void);
              A.S(message);
              new A._AsyncCompleter(t1, type$._AsyncCompleter_dynamic).complete$1(0, message);
              // implicit return
