String getFirestoreNotesCollectionPath(String id) => 'thoughtbookData/$id/notes';

String getFirestoreNoteTagsCollectionPath(String id) => 'thoughtbookData/$id/noteTags';
